      ...
      role="tab" aria-controls="v-Anti-Aqar2-Committee" aria-selected="false" tabindex="-1">Criterion 2</button>
                    ...
                    <div class="tab-content" id="v-pills-tabContent">
                        ...
                        <div class="committee_table" id="naac-first">
                            ...
                            <!-- <div class="tab-pane animate__animated animate__fadeInUp" id="v-Anti-extra1-Committee" role="tabpanel" aria-labelledby="v-Anti-extra1-Committee-tab" tabindex="0">
                            <div class="committee_table" id="naac-first">
                                <div class="committee_head">
                                    <h3>Extended Profile
                                    </h3>
