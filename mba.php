  <?php
    ...
    $query = "SELECT sno, department, description, status FROM dep_about WHERE department_name = 'MBA'";

    $result = mysqli_query($con, $query);
    // $query1 = "SELECT id, branch_name, lab_name, number_of_systems, lab_details, laboratories, syllabus, timetable, academic_calendar FROM dep_btech WHERE branch_name = 'MBA'";

    // $result2 = mysqli_query($con, $query1);
    // for query Btech syllabus
    $query01 = "SELECT * FROM dep_btech_syllabus WHERE branch = 'MBA'";

    $result01 = mysqli_query($con, $query01);
    // for query btech timetable
    // $query02 = "SELECT * FROM dep_btech_timetable WHERE branch = 'MBA'";

    // $result02 = mysqli_query($con, $query02);

    // for query btech academic calendar

    // $query03 = "SELECT * FROM dep_btech_academic_calendar WHERE branch = 'MBA'";

    // $result03 = mysqli_query($con, $query03);

    // for query btech lab configurations

    $query04 = "SELECT * FROM laboratories_config WHERE department_name = 'MBA'";

    $result04 = mysqli_query($con, $query04);

    // for query btech lab details

    // $query05 = "SELECT * FROM  labdetails WHERE department LIKE 'MBA' ORDER BY 	date_of_creation ASC";
    ...
    // for mtech Syllabus
    $query06 = "SELECT * FROM  mtech_syllabus WHERE department_name LIKE 'MBA'";

    $result06 = mysqli_query($con, $query06);

    // for mtech Timetable
    // $query07 = "SELECT * FROM  mtech_timetable WHERE department_name LIKE 'MBA'";

    // $result07 = mysqli_query($con, $query07);

    // for mtech Academic Calendar
    // $query08 = "SELECT * FROM  mtech_academic_calendar WHERE department_name LIKE 'MBA'";

    // $result08 = mysqli_query($con, $query08);
    // for mtech Academic Laboratories
    // $query09 = "SELECT * FROM  mtech_laboratories WHERE department_name LIKE 'MBA'";
    ...
    // $query2 = "SELECT lab_name, lab_details FROM dep_btech WHERE branch_name = 'MBA'";

    // $result3 = mysqli_query($con, $query2);
    // Close the database connection
    // mysqli_close($con);
    // $query3 = "SELECT id, branch_name, lab_name, number_of_systems, lab_details, laboratories, syllabus, timetable, academic_calendar FROM dep_mtech WHERE branch_name = 'MBA'";
    // $result4 = mysqli_query($con, $query3);


    $query4 = "SELECT * FROM faculty_event2 WHERE department = 'MBA' ORDER BY date_of_creation DESC";
    $result5 = mysqli_query($con, $query4);


    $query5 = "SELECT * FROM dep_faculty_publications2 WHERE department LIKE 'MBA' ORDER BY date_of_creation DESC";
    $result6 = mysqli_query($con, $query5);

    $query6 = "SELECT * FROM dep_faculty_innovations2 WHERE department = 'MBA' ORDER BY date_of_creation DESC";
    $result7 = mysqli_query($con, $query6);
    // mysqli_close($con);
    // for student events
    // $query7 = "SELECT * FROM student_events2 WHERE department = 'MBA' ORDER BY date_of_creation DESC";
    // $result8 = mysqli_query($con, $query7);

    // for student placement

    // $query8 = "SELECT * FROM student_placements2 WHERE department = 'MBA' ORDER BY date_of_creation DESC";
    // $result9 = mysqli_query($con, $query8);

    // for contcat Hod Dynamic 


    $query9 = "SELECT * FROM contact_hod WHERE department = 'MBA' ORDER BY id ASC LIMIT 1";
    $result10 = mysqli_query($con, $query9);

    // for Co's Po's

    $query10 = "SELECT * FROM contact_hod WHERE department = 'MBA'";
  ...
  <head>
      ...
      <style>
          ...
          /* Apply numbering only to tables that don't have the class 'table-number' */
     /* Prevent the numbering by overriding with !important */
            ...
            <div class="col-lg-8">
                <div id="contact-info">
                    ...
                    <div class="cse-hod2">
                        ...
                        <p><b>Email:</b>'.htmlspecialchars(trim($email)) . '</p>
                    </div>
                </div>
            </div>
        </div>';
                          ...
                          <?php
                            ...
                            ?>
                              ...
                              <div class="tab-pane animate__animated animate__fadeInUp" id="v-e-resources" role="tabpanel" aria-labelledby="v-e-resources-tab" tabindex="0">
                                  ...
                                  <div
                                      ...
                                      <div
                                          ...
                                          <p><?php echo "<div><h3>Coming Soon</h3></div>" ?></p>
                                      </div>
                                  </div>
                              </div>
                              ...
                              <?php
                                ...
                                $query = "SELECT * FROM dep_faculty_profile WHERE department = 'MBA' ORDER BY id ASC";
                                $result = mysqli_query($con, $query);
                                  ...
                                  <div class="accordion" id="faculty_list">
                                      <?php
                                        if (mysqli_num_rows($result6) > 0) {
                                            ...
                                            echo "<p style='text-alight:left;font-weight:bold;font-size: x-large;'>Coming Soon.</p>";
                                        }
                              ...
                              <div class="tab-pane animate__animated animate__fadeInUp" id="v-News" role="tabpanel" aria-labelledby="v-News-tab" tabindex="0">
                                  ...
                                  <p style='text-alight:left;font-weight:bold;font-size: x-large;'>Coming Soon.</p>
                              </div>
