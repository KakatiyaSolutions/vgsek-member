 ...
 <section class="cse-sec">
        <div class="container">
            <div class="row">
                ...
                // mysqli_close($con);
                // for student events
                $query7 = "SELECT * FROM student_events2 WHERE department = 'ECE' ORDER BY date_of_creation ASC";
                $result8 = mysqli_query($con, $query7);

                // for student placement

                $query8 = "SELECT * FROM student_placements2 WHERE department = 'ECE' ORDER BY date_of_creation ASC";
