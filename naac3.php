...
// $query = "SELECT * FROM naac WHERE criterion LIKE 'Criterion 1' AND status = 1 AND topic_parent !=0"; // Query to get data for Criterion 1
$query = "SELECT * FROM naac WHERE criterion LIKE 'Criterion 1' AND status = 1 AND topic_parent != 0 AND type = 'SSR';"; // Query to get data for Criterion 1
...
if ($result) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        // Encode the image if it's available
        // if (!empty($row['image'])) {
        //     $row['image'] = base64_encode($row['image']);
        // } else {
        //     $row['image'] = null; // If no image, set it as null
        // }
        // Push the row into the data array
        $data[] = $row;
    }
}
$query2 = "SELECT * FROM naac WHERE criterion LIKE 'Criterion 2' AND status = 1 AND topic_parent != 0 AND type = 'SSR';"; // Query to get data for Criterion 1
                                 ...
                                 <div class="col-lg-8 col-md-8 col-sm-8 col-8">
                                   ...
                                   <div class="row naac-sen naac-sen">
                                        <?php foreach ($data as $row): ?>
                                            <div class="col-lg-8 col-md-8 col-sm-8 col-8">
                                                <div class="criterion">
                                                    <p>Criterion: <?= htmlspecialchars($row['topic']) ?></p>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-4">
                                                <div class="view">
                                    ...
                                    <!-- <div class="row naac-sen">
                                      ...
                                      <div class="row naac-sen naac-sen">
                                        <?php foreach ($data2 as $row2): ?>
                                            <div class="col-lg-8 col-md-8 col-sm-8 col-8">
                                                <div class="criterion">
                                                    <p>Criterion: <?= htmlspecialchars($row2['topic']) ?></p>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-4">
                                                <div class="view">
                                                    <p><a href="assets/pdfs/ssr/<?= htmlspecialchars($row2['topic_file']) ?>" target="_blank">Click here</a></p>
                                                </div>
                                            </div>
                                        <?php endforeach; ?>
                                    </div>
