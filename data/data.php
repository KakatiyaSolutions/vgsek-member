                    ...
                    <div class="container">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">CSE (Data Science)</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3">
                    ...
                    <h2 class="widget-title">CSE (Data Science) Department</h2>
                                ...
                                <div id="collapse_overview" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                                    <div class="accordion-body department_accord_body">
                                        ...
                                        <button class="nav-link deprmnt_btn_act" id="v-pills-achi-tab" data-bs-toggle="pill" data-bs-target="#v-pills-achi" type="button" role="tab"
                                            aria-controls="v-pills-achi" aria-selected="false">Achievements</button>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item departmnt_acord_item">
                ...
                <div class="col-lg-9">
                    <div class="tab-content" id="v-pills-tabContent">
                        ...
                        <div class="tab-pane fade animate__animated animate__fadeInUp" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab" tabindex="0">
                            <div class="pro-vision">
                                <div class="mission-total">
                                    <div class="vision">
                                        <h1>Vision</h1>
                                        <p>To acknowledge quality education and instill high patterns of discipline making the students technologically superior
                                            and ethically strong which involves the improvement in the quality of life in them.</p>
                                    </div>
                                    <img src="http://kakatiyasolutions.in/vageshwari_clg/assets/images/logo/vision.png" class="img-fluid" loading="lazy" alt="mission-logo">
                                </div>
                                                        ...
                                                        <table class="table table-bordered table-striped">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>The students must design and develop the solutions using the latest software for the
                                                                        objective of task execution in a particular domain.</td>

                                                                </tr>
                                                                <tr>
                                                                    <td></td>
                                                                    <td>Program Specific Outcomes - 2</td>
                                                                    <td>Utilize computer science and Information Technology Techniques for industrial application in independent systems like
                                                                        cloud computing , Artificial intelligence, natural language processing, computer vision and emerging areas</td>
                        ...
                        <div class="tab-pane fade animate__animated animate__fadeInUp " id="v-pills-lab" role="tabpanel" aria-labelledby="v-pills-lab-tab" tabindex="0">
                            ...
                            <!--            <div>-->
                            <!--                <a href="https://kakatiyasolutions.in/vageshwari_clg/assets/images/cse/cse-lab1.webp" data-fancybox="gallery" data-caption="Caption Images 1">-->
                            <!--                    <img src="https://kakatiyasolutions.in/vageshwari_clg/assets/images/cse/cse-lab1.webp" alt="Image 1" class="img-fluid" loading="lazy" decoding="async"></a>-->
                            <!--                <div class="overlay">-->
                            <!--                    <p>Cse Lab-1 </p>-->
                            <!--                </div>-->
                            <!--            </div>-->
                            ...
                            <!--            <div>-->
                            <!--                <a href="https://kakatiyasolutions.in/vageshwari_clg/assets/images/cse/cse-lab2.webp" data-fancybox="gallery" data-caption="Caption Images 1">-->
                            <!--                    <img src="https://kakatiyasolutions.in/vageshwari_clg/assets/images/cse/cse-lab2.webp" alt="Image 2" class="img-fluid" loading="lazy" decoding="async"></a>-->
                            <!--                <div class="overlay">-->
                            <!--                    <p>Cse Lab-2 </p>-->
                            <!--                </div>-->
                            <!--            </div>-->
                            <!--            <div>-->
                            <!--                <a href="https://kakatiyasolutions.in/vageshwari_clg/assets/images/cse/cse-lab3.webp" data-fancybox="gallery" data-caption="Caption Images 1">-->
                            <!--                    <img src="https://kakatiyasolutions.in/vageshwari_clg/assets/images/cse/cse-lab3.webp" alt="Image 3" class="img-fluid" loading="lazy" decoding="async"></a>-->
                            <!--                <div class="overlay">-->
                            <!--                    <p>Cse Lab-3 </p>-->
                            <!--                </div>-->
                            <!--            </div>-->
                            <!--            <div>-->
                            <!--                <a href="https://kakatiyasolutions.in/vageshwari_clg/assets/images/cse/cse-lab1.webp" data-fancybox="gallery" data-caption="Caption Images 1">-->
                            <!--                    <img src="https://kakatiyasolutions.in/vageshwari_clg/assets/images/cse/cse-lab4.webp" alt="Image 4" class="img-fluid" loading="lazy" decoding="async">-->
                            <!--                </a>-->
                            <!--                <div class="overlay">-->
                            <!--                    <p>Cse Lab-4 </p>-->
                            <!--                </div>-->
                            <!--            </div>-->
                            <!--            <div>-->
                            <!--                <a href="https://kakatiyasolutions.in/vageshwari_clg/assets/images/cse/cse-lab5.webp" data-fancybox="gallery" data-caption="Caption Images 1">-->
                            <!--                    <img src="https://kakatiyasolutions.in/vageshwari_clg/assets/images/cse/cse-lab5.webp" alt="Image 5" class="img-fluid" loading="lazy" decoding="async">-->
                            <!--                </a>-->
                            <!--                <div class="overlay">-->
                            <!--                    <p>Cse Lab-5 </p>-->
                            <!--                </div>-->
                            <!--            </div>-->
                            <!--            <div>-->
                            <!--                <a href="https://kakatiyasolutions.in/vageshwari_clg/assets/images/cse/cse-lab6.webp" data-fancybox="gallery" data-caption="Caption Images 1">-->
                            <!--                    <img src="https://kakatiyasolutions.in/vageshwari_clg/assets/images/cse/cse-lab6.webp" alt="Image 5" class="img-fluid" loading="lazy" decoding="async">-->
                            <!--                </a>-->
                            <!--                <div class="overlay">-->
                            <!--                    <p>Cse Lab-6 </p>-->
                            <!--                </div>-->
                            <!--            </div>-->
                            <!--            <div>-->
                            <!--                <a href="https://kakatiyasolutions.in/vageshwari_clg/assets/images/cse/project-img.webp" data-fancybox="gallery" data-caption="Caption Images 1">-->
                            <!--                    <img src="https://kakatiyasolutions.in/vageshwari_clg/assets/images/cse/project-img.webp" alt="Image 5" class="img-fluid" loading="lazy" decoding="async">-->
                            <!--                </a>-->
                            <!--                <div class="overlay">-->
                            <!--                    <p>Project Lab </p>-->
                            <!--                </div>-->
                            <!--            </div>-->
                            <!--            <div>-->
                            <!--                <a href="https://kakatiyasolutions.int/vageshwari_clg/assets/images/cse/project-img2.webp" data-fancybox="gallery" data-caption="Caption Images 1">-->
                            <!--                    <img src="https://kakatiyasolutions.in/vageshwari_clg/assets/images/cse/project-img2.webp" alt="Image 5" class="img-fluid" loading="lazy" decoding="async">-->
                            <!--                </a>-->
                            <!--                <div class="overlay">-->
                            <!--                    <p> Project Lab </p>-->
                            <!--                </div>-->
...
<!--<tr>-->
<!--<td></td>-->
<!--<td>IoT Supply Chain andM2M Supply Chain -Internet of Things</td>-->
<!--<td>Workshop</td>-->
<!--<td>22/08/2022</td>-->
<!--<td>Mr. B Yakub, Junior ResearchEngineer at Cyberaegis ITSolutions Pvt. Limited,Hyderabad</td>-->
<!--<td>95</td>-->
...
<!--<tr>-->
<!--<td></td>-->
<!--<td>Prevention of DigitalAttacks – CyberSecurity</td>-->
<!--<td>Workshop</td>-->
<!--<td>11/08/2022</td>-->
<!--<td>Mr. B Yakub, Junior ResearchEngineer at Cyberaegis ITSolutions Pvt. Limited,Hyderabad</td>-->
<!--<td>96 </td>-->
...
<!--<td>GuestLecturer</td>-->
<!--<td>03/09/2022</td>-->
<!--<td>Mr. M. Aravind Kumar, AssistantProfessor,-->
<!--Sri Chaitanya College ofEngineering, Karimnagar-->
<!--</td>-->
<!--<td>97</td>-->
...
<!--Associate Professor,-->
<!--Sri Chaitanya College of Engineering, Karimnagar</td>-->
<!--<td>96</td>-->
...
<!--<tr>-->
<!--<td></td>-->
<!--<td>Essential elements of design patterns andhow to solve realworld problems using design</td>-->
<!--<td>GuestLecture</td>-->
<!--<td>24/09/2022</td>-->
<!--<td>Mr. Raghu Nagunoori,-->
<!--Assistant Professor,-->
<!--Kamala Institute of Technologyand Science, Singapur,Telangana-->
<!--</td>-->
<!--<td>97</td>-->
...
<!--<tr>-->
<!--<td></td>-->
<!--<td>Keras and Tensor flowfor developing theApplications ofMachine Learning</td>-->
<!--<td>Workshop</td>-->
<!--<td>18/10/2022</td>-->
...
<!--Assistant Professor,-->
<!--Kamala Institute of TechnologyScience, Singapur, Telangana-->
<!--</td>-->
<!--<td>97</td>-->
...
<!--<td>GuestLecturer</td>-->
<!--<td>25/11/2022</td>-->
<!--<td>Dr. P. Sammulal, Professor,JNTUH College of Engineering,Jagityal-->
<!--</td>-->
<!--<td>98</td>-->
...
<!--<td>12/07/2021</td>-->
<!--<td>Dr. B. Vishnuvardhan, Sr.Professor, JNTUH College ofEngineering, Jagityal</td>-->
<!--<td>98</td>-->
...
<!--<td>Workshop</td>-->
<!--<td>20/10/2021 </td>-->
<!--<td>Mr. Sanjeevaraju Akinapalli,Assistant Professor,-->
<!--Kamala Institute of Technologyand Science, Singapur,Telangana-->
<!--</td>-->
<!--<td>97</td>-->
...
<!--<td>GuestLecture</td>-->
<!--<td>18/11/2021</td>-->
<!--<td>Mr. P. Sreenivasa Rao,Associate Professor,-->
<!--JNTUH College of Engineering,Jagityal-->
<!--</td>-->
<!--<td>96</td>-->
...
<!--<tr>-->
<!--<td></td>-->
<!--<td>Introduction toDatabases and its Connectivity</td>-->
<!--<td>TrainingProgram</td>-->
<!--<td>22/11/2021</td>-->
...
<!--<tr>-->
<!--<td></td>-->
<!--<td>Introduction toArtificial Intelligence</td>-->
<!--<td>Workshop</td>-->
<!--<td>02/12/2021</td>-->
<!--<td>Mr. Uday Kumar,-->
<!--Associate Professor,-->
...
<!--<td>Mr. Uday Kumar,-->
<!--Associate Professor,-->
<!--Sri Chaitanya College ofEngineering, Karimnagar </td>-->
<!--<td>96</td>-->

<!--</tr>-->
<!--<tr>-->
<!--<td></td>-->
<!--<td>AdvancedComputation andGraphics using C++</td>-->
<!--<td>GuestLecture</td>-->
<!--<td>17/12/2021</td>-->
<!--<td>Mr. Pavan Kumar Jamalpur,Assistant Professor,-->
<!--Kamala Institute of Technologyand Science, SingapurTelangana-->
<!-- </td>-->
<!--<td>98</td>-->
...
<!--<td>01/02/2022</td>-->
<!--<td>Mr. Mr. Rachakatla Saiteja,Assistant Professor,Jyothishmathi Institute ofTechnology and Science,Karimnagar-->
<!-- </td>-->
<!--<td>98</td>-->
...
<!--<tr>-->
<!--<td></td>-->
<!--<td>MVC Architecture inDesign Patterns andDescribing DesignPatterns</td>-->
<!--<td>Guestlecture</td>-->
<!--<td>04/12/2020</td>-->
<!--<td>Mr. Khaja Ziauddin, AssociateProfessor,-->
<!--Sri Chaitanya College ofEngineering, Karimnagar-->
...
<!--<tr>-->
<!--<td></td>-->
<!--<td>Industry LevelProblems &, How toOrganize Data</td>-->
<!--<td>NPTEL</td>-->
<!--<td>07/12/2020</td>-->
...
<!--<tr>-->
<!--<td></td>-->
<!--<td>The Concept of Real-Time OperatingSystem</td>-->
<!--<td>NPTEL</td>-->
<!--<td>28/12/2020</td>-->
...
<!--<tr>-->
<!--<td></td>-->
<!--<td>Cray 1, Cyber 205,Super ComputerArchitecture</td>-->
<!--<td>Workshop</td>-->
<!--<td>08/02/2021</td>-->
<!--<td>Mr. B Yakub, Junior ResearchEngineer at Cyberaegis ITSolutions Pvt. Limited,Hyderabad</td>-->
<!--<td>97</td>-->
...
<!--<td>19/12/2020</td>-->
<!--<td>Mr. G Srinivasulu, Retired AirForce Officer, Senior Consultant,ISAC, Hyderabad</td>-->
<!--<td>98</td>-->
...
<!--<td>NPTEL</td>-->
<!--<td>04/01/2021</td>-->
<!--<td>Prof P Sudap Misra, IIT,Kharagpur, West Bengal</td>-->
<!--<td>99</td>-->
...
<!--<tr>-->
<!--<td></td>-->
<!--<td>Practical Exposure ofPython Programming(DatabaseConnectivity)</td>-->
<!--<td>GuestLecturer</td>-->
<!--<td>05/01/2021</td>-->
<!--<td>Dr. P. Sammulal, Professor,JNTUH College of Engineering ,Jagityal</td>-->
<!--<td>98</td>-->
...
<!--</div>-->
                        ...
                        <div class="tab-pane fade animate__animated animate__fadeInUp " id="v-pills-pub" role="tabpanel" aria-labelledby="v-pills-pub-tab" tabindex="0">
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>Social Media analysis with Active Online Learning to Support Crisis Management</td>-->
                            <!--                                        <td>Dr. N. Chandra Mouli</td>-->
                            <!--                                        <td>The International Journal of Analytical and Experimental Modal analysis</td>-->
                            <!--                                        <td>2023</td>-->
                            <!--                                        <td>0886-9367</td>-->
                            <!--                                    </tr>-->
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>Biometric-Based Secure Access Mechanism for Cloud Services</td>-->
                            <!--                                        <td>Dr. N. Chandra Mouli</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>Protection for Your Purchase Preferences with Differential Privacy</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>Diabetes Prediction Using Machine Learning Algorithms</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>Enabling Identity Based Integrity Auditing and Data Sharing with Sensitive Information Hiding for Secure Cloud Storage</td>-->
                            <!--                                        <td>Dr. E. Srikanth Reddy</td>-->
                            <!--                                        <td>The International Journal of Analytical and Experimental Modal analysis</td>-->
                            <!--                                        <td>2023</td>-->
                            <!--                                        <td>0886-9367</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>Movie Recommendation system Using Sentiment Analysis from Microblogging Data</td>-->
                            <!--                                        <td>Dr. Dinesh Kumar</td>-->
                            <!--                                        <td>The International Journal of Analytical and Experimental Modal analysis</td>-->
                            <!--                                        <td>2023</td>-->
                            <!--                                        <td>0886-9367</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>Secure Keyword Search and Data Sharing Mechanism for Cloud</td>-->
                            <!--                                        <td>Mr. K. Sridhar Reddy</td>-->
                            <!--                                        <td>The International Journal of Analytical and Experimental Modal analysis</td>-->
                            <!--                                        <td>2023</td>-->
                            <!--                                        <td>0886-9367</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>Trust-Based Photo Sharing in Online Social Networks with Privacy Preserving</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>A Three-Layer Privacy Preserving Cloud Storage Scheme Based on Computational Intelligence in Fog Computing</td>-->
                            <!--                                        <td>Dr. G.S. Chowhan</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>Machine Learning Algorithms For Predicting Criminal Activity Nature And Frequency</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>An Efficient Pricing Scheme For Data Markets In Real Time Environment</td>-->
                            <!--                                        <td>Dr. E. Srikanth Reddy</td>-->
                            <!--                                        <td>Juni Khyat</td>-->
                            <!--                                        <td>2023</td>-->
                            <!--                                        <td>2278-4632</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>Assessment of the Online ADMM-BASED Extreme Learning Machines Utilization for Partial Supervised Learning</td>-->
                            <!--                                        <td>Dr. Gulab Singh</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>E-Commerce Assessment Prediction Based On Sentiment Analysis Of Users And User Trust</td>-->
                            <!--                                        <td>Dr. E. Srikanth Reddy</td>-->
                            <!--                                        <td>Journal of Nonlinear Analysis and Optimization</td>-->
                            <!--                                        <td>Jun-23</td>-->
                            <!--                                        <td>1906-9685</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>The CNN employed in the elimination of background was cleaned using an innovative image proposal method.</td>-->
                            <!--                                        <td>T. Ravi Kumar </td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>Examination of the Block Chain for Secured EHR Sharing in Mobile Cloud-Based E-Health Systems</td>-->
                            <!--                                        <td>Y. Susheela </td>-->
                            <!--                                        <td>Mukt Shabd Journal</td>-->
                            <!--                                        <td>2022-2023</td>-->
                            <!--                                        <td>2347-3150</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>Examination and Determination of Customers Churns Using Data Mining Models in the Banking Industry</td>-->
                            <!--                                        <td>Y. Susheela </td>-->
                            <!--                                        <td>Mukt Shabd Journal</td>-->
                            <!--                                        <td>2022-2023</td>-->
                            <!--                                        <td>2347-3150</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>Analysis on Identification and Categorization of Happ Systems for Smart Home Uses on Personal Activities</td>-->
                            <!--                                        <td>A. Mahendar </td>-->
                            <!--                                        <td>Mukt Shabd Journal</td>-->
                            <!--                                        <td>2022-2023</td>-->
                            <!--                                        <td>2347-3150</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>A Significant Reduction of Counting Based Bloom Filtering for Secure Data Transfer in Cloud Computing</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>Data Security Control and Ground Performance in the Industrial IOT Platform by Employing a Safe and Fine Grained Systems</td>-->
                            <!--                                        <td>Md.Sirajuddin</td>-->
                            <!--                                        <td>Industrial Engineering Journal</td>-->
                            <!--                                        <td>2022-2023</td>-->
                            <!--                                        <td> 0970-2555</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>An Examination-Based Data Sharing Technique and Encryption-Based Secured Keyword Search for Cloud Computing Using CPAB-KSDS</td>-->
                            <!--                                        <td>Dr.D.Srinivas Reddy </td>-->
                            <!--                                        <td>Journal of Nonlinear Analysis and Optimization</td>-->
                            <!--                                        <td>2022-2023</td>-->
                            <!--                                        <td>1906-9685</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>Approaches for Detecting Spammers and Identifying Fake Users on Social Networks that Rely on Random Forests and Naive Bays</td>-->
                            <!--                                        <td>K.Sridhar</td>-->
                            <!--                                        <td>Industrial Engineering Journal</td>-->
                            <!--                                        <td>2022-2023</td>-->
                            <!--                                        <td> 0970-2555</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>Automate Multimedia Cloud Computing: A Computing Structure for Efficient Resource Allocation Based on Dynamic Priority</td>-->
                            <!--                                        <td>A.Mahendar</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>A Study on Employing the Adaptable Voting Classifier Combined Technique for Pre-Diagnosis of Breast Cancer</td>-->
                            <!--                                        <td> K.Sridhar </td>-->
                            <!--                                        <td>Industrial Engineering Journal</td>-->
                            <!--                                        <td>2021-2022</td>-->
                            <!--                                        <td> 0970-2555</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>A Data Sharing Protocol To Minimize Security And Privacy Risks Of Cloud Storage In Big Data Era 2750 RB Journal of Lib & Information Sc</td>-->
                            <!--                                        <td>Dr. D. Srinivas Reddy</td>-->
                            <!--                                        <td>RB Journal of Lib & Information Science</td>-->
                            <!--                                        <td>2021-2022</td>-->
                            <!--                                        <td>0972-2750</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>An Accurate Designing and Developing Of Anti-Malware Systems To Ensure The Identified Threat Using LSTM</td>-->
                            <!--                                        <td>Dr. D. Srinivas Reddy</td>-->
                            <!--                                        <td>Journal of Nonlinear Analysis and Optimization</td>-->
                            <!--                                        <td>2021-2022</td>-->
                            <!--                                        <td>1906-9685</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>Excellent Protection from Network Assaults on Effective Development of Organization Safety Concerns</td>-->
                            <!--                                        <td>Dr. D. Srinivas Reddy</td>-->
                            <!--                                        <td>Journal of Nonlinear Analysis and Optimization</td>-->
                            <!--                                        <td>2021-2022</td>-->
                            <!--                                        <td>1906-9685</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>A Dissertation to Improve Cloud Environment Safety by Utilizing Key Sharing and Two-Factor Authentication Mechanisms</td>-->
                            <!--                                        <td>Dr. D. Srinivas Reddy</td>-->
                            <!--                                        <td>Journal of Nonlinear Analysis and Optimization</td>-->
                            <!--                                        <td>2021-2022</td>-->
                            <!--                                        <td>1906-9685</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>A Deep Learning Model for Average Fuel Usage in Large Vehicles</td>-->
                            <!--                                        <td>Dr. N. Chandra mouli</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>Enhancing The Privacy For Message Authentication Using Cryptographic Methods In Internet Of Things</td>-->
                            <!--                                        <td>Dr. N. Chandra Mouli</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>Review of Dynamic Resource Distribution for Profit Maimization in Cloud Computing</td>-->
                            <!--                                        <td>Dr. N. Chandra Mouli</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>Consuming Big Data for Reporting Heavy Users in Top Video Apps</td>-->
                            <!--                                        <td>Dr. N. Chandra Mouli</td>-->
                            <!--                                        <td>Mukt Shabd Journal</td>-->
                            <!--                                        <td>2020 - 21</td>-->
                            <!--                                        <td>2347-3150</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>Cloud Based Mechine Learning with Advanced Predictive Analytics Using Google Colaboratory</td>-->
                            <!--                                        <td>Mr. T. Ravi Kumar</td>-->
                            <!--                                        <td>Materials Today: Proceedings, Elsevier Publisher,</td>-->
                            <!--                                        <td>2020 - 21</td>-->
                            <!--                                        <td>2214-7853</td>-->
                            <!--                                    </tr>-->
                            <!--                                    <tr>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>Using Machine Learning Models to Predict Growth of Plant and Output in Greenhouse Environments</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>Analysis of the Efficiency of Machine Learning Methods for Disease Prediction</td>-->
                            <!--                                        <td>Dr. G. S. Chauhan</td>-->
                            <!--                                        <td>International Journal of Research Publication and Reviews</td>-->
                            <!--                                        <td>2021-2022</td>-->
                            <!--                                        <td>2582-7421</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>An Assessment on the Effectiveness and Precision of Many Machine Learning Techniques for the Naive Bayes Algorithm-Based Picture Classification</td>-->
                            <!--                                        <td>Dr. Gulab Singh,</td>-->
                            <!--                                        <td>Journal of Nonlinear Analysis and Optimization</td>-->
                            <!--                                        <td>2021-2022</td>-->
                            <!--                                        <td>1906-9685</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>A Evaluation of Machine Learning for Predicting the Risk for Acquiring a Chronic Disease System</td>-->
                            <!--                                        <td>Dr. Gulab Singh</td>-->
                            <!--                                        <td>Industrial Engineering Journal</td>-->
                            <!--                                        <td>2021-2022</td>-->
                            <!--                                        <td> 0970-2555</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>An Efficient Spam Detection Technique ForIot Devices Using Machine Learning</td>-->
                            <!--                                        <td>MD. Sirajuddin</td>-->
                            <!--                                        <td>RB Journal of Lib & Information Science</td>-->
                            <!--                                        <td>2021-2022</td>-->
                            <!--                                        <td>0972-2750</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>An Efficient and Effective Access Control Method for Mobile Cloud Computing Using MHABE Fine Grained Graining</td>-->
                            <!--                                        <td>Md.Sirajuddin</td>-->
                            <!--                                        <td>Industrial Engineering Journal</td>-->
                            <!--                                        <td>2021-2022</td>-->
                            <!--                                        <td> 0970-2555</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>A Unique Technique using Neural Network Approaches for the Detection and Recognition of Diabetic Retinopathy</td>-->
                            <!--                                        <td>Md.Sirajuddin</td>-->
                            <!--                                        <td>Industrial Engineering Journal</td>-->
                            <!--                                        <td>2021-2022</td>-->
                            <!--                                        <td> 0970-2555</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>IP-Mod: Secure Privilege-Based Multilevel Organizational Data-Sharing In Cloud Computing</td>-->
                            <!--                                        <td>Dr. E. Srikanth Reddy</td>-->
                            <!--                                        <td>RB Journal of Lib & Information Science</td>-->
                            <!--                                        <td>2021-2022</td>-->
                            <!--                                        <td>0972-2750</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>Intelligent IOT Services Based on Artificial and Machine Learning Technology</td>-->
                            <!--                                        <td>Dr. E. Srikanth Reddy</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>IOT Based Indoor And Outdoor Air Pollution Monitoring System Using Raspberry PI</td>-->
                            <!--                                        <td>Dr. E. Srikanth Reddy</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>Ad Sherlock Efficient Deployable Click Fraud Detection for Mobile Applications</td>-->
                            <!--                                        <td>Dr. Dinesh Kumar</td>-->
                            <!--                                        <td>International Journal of Research Publication and Reviews</td>-->
                            <!--                                        <td>2021-2022</td>-->
                            <!--                                        <td>2582-7421</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>E-Agri Kit: Agricultural Aid Using Deep Learning</td>-->
                            <!--                                        <td>Dr. Dinesh Kumar</td>-->
                            <!--                                        <td>International Journal of Science, Engineering and Technology</td>-->
                            <!--                                        <td>2021-2022</td>-->
                            <!--                                        <td>2348-4098</td>-->
                            <!--                                    </tr>-->
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>Scalable And Secure Big Data Iot System Based On Multifactor Authentication And Lightweight Cryptography</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>The Assessment of Fuzzy Support Early Diabetes Prediction using Vector Regression Method</td>-->
                            <!--                                        <td>K.Sridhar</td>-->
                            <!--                                        <td>Industrial Engineering Journal</td>-->
                            <!--                                        <td>2021-2022</td>-->
                            <!--                                        <td> 0970-2555</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>Secure Data Transfer And Deletion Using Counter Blooming Filter By Cloud Computing</td>-->
                            <!--                                        <td>S Sateesh Reddy</td>-->
                            <!--                                        <td>RB Journal of Lib & Information Science</td>-->
                            <!--                                        <td>2022</td>-->
                            <!--                                        <td>0972-2750</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>Imperative Length Extension of Encrypted Control System through Fog Computing</td>-->
                            <!--                                        <td>Dr.T.Ravi Kumar</td>-->
                            <!--                                        <td>Science, Technology and Development</td>-->
                            <!--                                        <td>2021-2022</td>-->
                            <!--                                        <td>0950-0707</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>Integration of LSTM and Recurrent Neural Networks for the Prediction of Steel worker Dyslipidemic Risk</td>-->
                            <!--                                        <td>Dr.T.Ravi Kumar</td>-->
                            <!--                                        <td>Science, Technology and Development</td>-->
                            <!--                                        <td>2021-2022</td>-->
                            <!--                                        <td>0950-0707</td>-->
                            ...
                            <!--                                    <tr>-->
                            <!--                                        <td></td>-->
                            <!--                                        <td>Examination of the Structure and Evolution of a Deep Learning Framework for Converting Sign Language to Spoken English</td>-->
                            <!--                                        <td>Y.Susheela</td>-->
                            <!--                                        <td>Science, Technology and Development</td>-->
                            <!--                                        <td>2021-2022</td>-->
                            <!--                                        <td>0950-0707</td>-->
    ...
    <!--                            <div class="accordion-item">-->
    <!--                                <h2 class="accordion-header">-->
    <!--                                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapsestudentsevents" -->
    <!--                                    aria-expanded="true" aria-controls="collapsestudentsevents">-->
    <!--                                    Academic Year: 2022-23-->
    <!--                                    </button>-->
    <!--                                </h2>-->
    <!--                                <div id="collapsestudentsevents" class="accordion-collapse collapse show" data-bs-parent="#student-events">-->
    ...
    <!--    <td>Dr. E. Srikanth Reddy</td>-->
    <!--    <td>1</td>-->
    <!--    <td><a href="http://kakatiyasolutions.in/vageshwari_clg/assets/pdfs/faculty-innovations/PPL-TOTAL.pdf" target="_blank">View</a></td>-->
    ...
    <!--    <td>Dr. Gulab Singh</td>-->
    <!--    <td>1</td>-->
    <!--    <td><a href="http://kakatiyasolutions.in/vageshwari_clg/assets/pdfs/faculty-innovations/DAA_Complete_Notes.pdf" target="_blank">View</a></td>-->
    ...
    <!--    <td>1</td>-->
    <!--    <td><a href="http://kakatiyasolutions.in/vageshwari_clg/assets/pdfs/faculty-innovations/Data_Minin_(Hand_Written).pdf" target="_blank">View</a></td>-->
    ...
    <!--    <td>1</td>-->
    <!--    <td><a href="http://kakatiyasolutions.in/vageshwari_clg/assets/pdfs/faculty-innovations/Cryptography_and_Network_Security_cmpltd.pdf" target="_blank">-->
    <!--    View</a></td>-->
    ...
    <!--    <td>1</td>-->
    <!--    <td><a href="http://kakatiyasolutions.in/vageshwari_clg/assets/pdfs/faculty-innovations/Java_BTech_CSE_2-2 Notes_241116_113337.pdf" target="_blank">-->
    <!--    View</a></td>-->
    ...
    <!--    <td>1</td>-->
    <!--    <td><a href="http://kakatiyasolutions.in/vageshwari_clg/assets/pdfs/faculty-innovations/DAA_Complete_Notes2.pdf" target="_blank">-->
    <!--    View</a></td>-->
    ...
    <!--    <td>1</td>-->
    <!--    <td><a href="http://kakatiyasolutions.in/vageshwari_clg/assets/pdfs/faculty-innovations/IRS_Notes.pdf" target="_blank">-->
    <!--    View</a></td>-->
    ...
    <!--    <td>Mr. R. Sagar</td>-->
    <!--    <td>1</td>-->
    <!--    <td><a href="http://kakatiyasolutions.in/vageshwari_clg/assets/pdfs/faculty-innovations/Cryptography_and_Network_Security_cmpltd2.pdf" target="_blank">-->
    <!--    View</a></td>-->
    ...
    <!--    <td>1</td>-->
    <!--    <td><a href="http://kakatiyasolutions.in/vageshwari_clg/assets/pdfs/faculty-innovations/Software_Engineering _notes.pdf" target="_blank">-->
    <!--    View</a></td>-->
    ...
    <!--    <td>1</td>-->
    <!--    <td><a href="http://kakatiyasolutions.in/vageshwari_clg/assets/pdfs/faculty-innovations/Compiler-Design-Complete-notes_3.pdf" target="_blank">-->
    <!--    View</a></td>-->
    ...
    <!--    <td>1</td>-->
    <!--    <td><a href="http://kakatiyasolutions.in/vageshwari_clg/assets/pdfs/faculty-innovations/FLAT_COMPLETE_NOTES.pdf" target="_blank">-->
    <!--    View</a></td>-->
    ...
    <!--    <td>1</td>-->
    <!--    <td><a href="http://kakatiyasolutions.in/vageshwari_clg/assets/pdfs/faculty-innovations/Cryptography_and_Network_Security_cmpltd3.pdf" target="_blank">-->
    <!--    View</a></td>-->
    ...
    <!--    <td>1</td>-->
    <!--    <td><a href="http://kakatiyasolutions.in/vageshwari_clg/assets/pdfs/faculty-innovations/HCI_Complete_notes.pdf" target="_blank">-->
    <!--    View</a></td>-->
    ...
    <!--                                                            <tr class="tableizer-firstrow">-->
    <!--                                                                <th>Sl. No.</th>-->
    <!--                                                                <th colspan="2">CSE Faculty YouTube Lecture Videos</th>-->
    ...
    <!--<tr>-->
    <!--    <td></td>-->
    <!--    <td>Hashing Techniques In DataStructures by Mr.E.Kiran Kumar</td>-->
       
    <!--    <td><a href="https://youtu.be/vfiN2Nuf5zo?si=ujmkeO_vv9ZzYzUR" target="_blank">-->
    <!--    View</a></td>-->
    ...
    <!--<tr>-->
    <!--    <td></td>-->
    <!--    <td>Relational Model in DBMS by Ms.Vidya</td>-->
       
    <!--    <td><a href="https://www.youtube.com/watch?v=Dft4EYN_j3A" target="_blank">-->
    <!--    View</a></td>-->
    ...
    <!--<tr>-->
    <!--    <td></td>-->
    <!--    <td>Routing Algorithms in ComputerNetworks by Mrs.A.Kalpana</td>-->
      
    <!--    <td><a href="https://www.youtube.com/watch?v=wMo5T7hUMSg" target="_blank">-->
    <!--    View</a></td>-->
    ...
    <!--<tr>-->
    <!--    <td></td>-->
    <!--    <td>WebTechnologies by Mr.S.Sateesh Reddy</td>-->
       
    <!--    <td><a href="https://www.youtube.com/watch?v=BgpAVvwKjgw" target="_blank">-->
    <!--    View</a></td>-->
    ...
    <!--<tr>-->
    <!--    <td></td>-->
    <!--    <td>Cryptography and Network Security by MD.Sirajuddin</td>-->
       
    <!--    <td><a href="https://www.youtube.com/watch?v=0CoJxyKIVTc" target="_blank">-->
    <!--    View</a></td>-->
    ...
    <!--<tr>-->
    <!--    <td></td>-->
    <!--    <td>IoT Supply Chain and M2M Supply Chain - Internet of Things</td>-->
    <!--    <td>Workshop</td>-->
    <!--    <td>22/08/2022</td>-->
    <!--    <td>Mr. B Yakub, Junior Research Engineer at  Cyberaegis IT Solutions Pvt. Limited, Hyderabad</td>-->
    <!--    <td>95</td>-->
        
    <!--</tr>-->
    <!--<tr>-->
    <!--    <td></td>-->
    <!--    <td>Prevention of Digital Attacks – Cyber Security</td>-->
    <!--    <td>Workshop</td>-->
    <!--    <td>11/08/2022</td>-->
    <!--    <td>Mr. B Yakub, Junior Research Engineer at Cyberaegis IT Solutions Pvt. Limited, Hyderabad</td>-->
    <!--    <td>96</td>-->
    ...
    <!--    <td>03/09/2022</td>-->
    <!--    <td>Mr. M. Aravind Kumar, Assistant Professor,Sri Chaitanya College of Engineering, Karimnagar</td>-->
    <!--    <td>97</td>-->
    ...
    <!--    <td>Guest Lecturer</td>-->
    <!--    <td>16/09/2022</td>-->
    <!--    <td>Mr. Khaja Ziauddin, Associate Professor, Sri Chaitanya  College of Engineering, Karimnagar</td>-->
    <!--    <td>96</td>-->
    ...
    <!--<tr>-->
    <!--    <td></td>-->
    <!--    <td>Essential elements of design patterns and how to solve real world problems using design</td>-->
    <!--    <td>Guest Lecture</td>-->
    <!--    <td>24/09/2022</td>-->
    <!--    <td>Mr. Raghu Nagunoori, Assistant Professor, Kamala Institute of Technology and Science, Singapur, Telangana</td>-->
    <!--    <td>97</td>-->
    ...
    <!--    <td>Guest Lecture</td>-->
    <!--    <td>10/10/2022</td>-->
    <!--    <td>Mr. Oggula Raju, Assistant Professor, JNTUH College of Engineering, Jagityal</td>-->
    <!--    <td>98</td>-->
      
    <!--</tr>-->
    <!--<tr>-->
    <!--    <td></td>-->
    <!--    <td>Keras and Tensor flow for developing the Applications of Machine Learning</td>-->
    <!--    <td>Workshop</td>-->
    <!--    <td>18/10/2022</td>-->
    <!--    <td>Mrs. Drava Arpitha, Assistant Professor, Sri Chaitanya College of Engineering, Karimnagar</td>-->
    <!--    <td>98</td>-->
    ...
    <!--    <td>Workshop</td>-->
    <!--    <td>11/11/2022</td>-->
    <!--    <td>Mr. Bhasker Prakash, Assistant Professor, Kamala Institute of Technology Science, Singapur, Telangana</td>-->
    <!--    <td>97</td>-->
    ...
    <!--    <td>Dr. B. Vishnuvardhan, Sr. Professor, JNTUH College of Engineering, Jagityal</td>-->
    ...
    <!--    <td>Mr. Sanjeevaraju Akinapalli, Assistant Professor, Kamala Institute of Technology and Science, Singapur, Telangana</td>-->
    ...
    <!--    <td>Mr. Raghu Nagunuri, Assistant Professor, Kamala institute of Technology and Science, Singapur, Telangana</td>-->
    ...
    <!--    <td>Mr. P.Sreenivasa Rao, Associate Professor, JNTUH College of Engineering, Jagityal</td>-->
    ...
    <!--<tr>-->
    <!--    <td></td>-->
    <!--    <td>Introduction to Databases and its Connectivity</td>-->
    <!--    <td>Training Program</td>-->
        
    <!--    <td>22/11/2021</td>-->
        
    <!--    <td>Mr. Kamarapu Naresh, Assistant Professor, Sri Chaitanya College of Engineering, Karimnagar</td>-->
    ...
    <!--    <td>Mr. Uday Kumar, Associate Professor, Sri Chaitanya College of Engineering, Karimnagar</td>-->
    ...
    <!--    <td>Mr. Pavan Kumar Jamalpur, Assistant Professor,Kamala Institute of Technology and Science, Singapur Telangana</td>-->
    ...
    <!--    <td>Mr. Venkatesh Thudum, Assistant Professor, JNTUH College of Engineering, Jagityal</td>-->
    ...
    <!--    <td>Dr. Sunitha Dodda, Associate Professor,Kamala Institute of Technology and Science, Singapur, Telangana</td>-->
    ...
    <!--    <td>MVC Architecture in Design Patterns and Describing Design Patterns</td>-->
    ...
    <!--    <td>Industry Level Problems &amp;, How to Organize Data</td>-->
    ...
    <!--    <td>Prof Rajib Mall,   IIT, Kharagpur Operating System</td>-->
    ...
    <!--    <td>Cray 1, Cyber 205, Super Computer Architecture</td>-->
    ...
    <!--    <td>Mr. G Srinivasulu, Retired Air Force Officer, Senior Consultant, ISAC, Hyderabad</td>-->
    ...
    <!--    <td>Practical Exposure of Python Programming (Database Connectivity)</td>-->
...
<!--                                <div class="col-lg-4">-->
<!--                                   <div class="hod-img">-->
<!--                                   <img src="<?php echo $base_url; ?>/assets/images/cse/Dr_ N_Chandramouli.webp" alt="contact_hod_img" class="img-fluid" loading="lazy" decoding="async">-->
...
<!--                                <div class="col-lg-8">-->
<!--                                    <div id="contact-info" >-->
<!--                                        <p>It is a great privilege for me to be part of the Vaageswari College of Engineering. Welcome all the students & their parents-->
<!--                                             to the Department of Computer Science and Engineering. Department of Computer Science & Engineering commits to work towards-->
<!--                                              developing Engineers with a rich blend of competent, technical, managerial and social skills and contribute to nation building.-->
<!--                                               Our Department has produced hundreds of professionals and has established a name for itself in the country and abroad. -->
<!--                                               To meet the objectives, department focus special emphasis on teaching and hands on practical work. The excellent infrastructure,-->
<!--                                                teaching faculty of the best kind of the Department ensuring quality education such as interaction among students, -->
<!--                                                parents and staff, along with a Training and Placement Cell ensures a bright future to the students. I invite you to be part of -->
<!--                                                our efforts as we propel the department of Computer Science & Engineering to ever-greater heights. I congratulate to the team of-->
<!--                                                 faculty members and the students for their brilliant and original efforts.</p>-->
